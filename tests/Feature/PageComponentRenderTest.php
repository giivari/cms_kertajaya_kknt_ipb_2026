...
class PageComponentRenderTest extends TestCase
{
    ...
    {
        $media = \App\Models\Media::create(['disk' => 'public', 'directory' => 'test', 'filename' => 'test.jpg', 'extension' => 'jpg', 'mime_type' => 'image/jpeg', 'size' => 100, 'original_filename' => 'test.jpg']);
    ...
    {
        $media = \App\Models\Media::create(['disk' => 'public', 'directory' => 'test', 'filename' => 'test2.jpg', 'extension' => 'jpg', 'mime_type' => 'image/jpeg', 'size' => 100, 'original_filename' => 'GalleryImage']);
    ...
    {
        $media = \App\Models\Media::create(['disk' => 'public', 'directory' => 'test', 'filename' => 'doc.pdf', 'extension' => 'pdf', 'mime_type' => 'application/pdf', 'size' => 100, 'original_filename' => 'Dokumen Penting']);
