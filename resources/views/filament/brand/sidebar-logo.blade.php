...
<div class="flex min-w-0 items-center gap-3">
    @if($logoUrl)
        <img src="{{ $logoUrl }}" alt="{{ $villageName }}" class="shrink-0 object-contain" style="width: 1.25rem !important; height: 1.25rem !important;">
    @else
        <div class="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-teal-600">
