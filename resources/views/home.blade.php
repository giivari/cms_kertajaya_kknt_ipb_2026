...
<section class="relative min-h-[90vh] md:min-h-screen flex flex-col justify-center overflow-hidden">
    ...
    <div class="w-full relative z-10 mx-auto px-4 md:px-8 lg:px-12 xl:px-24 2xl:px-32 pt-24 pb-32">
        <div class="max-w-3xl">
            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] sm:text-xs md:text-sm font-semibold uppercase tracking-wider bg-yellow text-navy mb-6">
                Selamat Datang di
            </span>
            <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[76px] 2xl:text-[84px] font-bold text-white leading-[1.1] tracking-tight mb-6 font-display">
                {{ \App\Services\SettingsService::get('hero_title', 'Desa yang Tumbuh Bersama Masyarakat') }}
            </h1>
            <p class="text-base sm:text-lg lg:text-xl 2xl:text-2xl text-white/90 mb-10 max-w-2xl leading-relaxed">
            ...
            <div class="flex flex-wrap items-center gap-4">
                ...
                <a href="{{ $link1 }}" class="inline-flex items-center justify-center rounded-full font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-teal focus:ring-offset-2 bg-teal text-white hover:bg-teal/90 shadow-sm px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base lg:text-lg">
                    {{ \App\Services\SettingsService::get('hero_button_1_text', 'Jelajahi Profil Desa') }}
                </a>
                @endif
                @if($link2 = $resolveLink('hero_button_2'))
                <a href="{{ $link2 }}" class="inline-flex items-center justify-center rounded-full font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-teal focus:ring-offset-2 border-2 border-white bg-white/10 text-white hover:bg-white hover:text-navy backdrop-blur-sm px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base lg:text-lg">
    ...
    <div class="bg-cream backdrop-blur-md shadow-xl rounded-[24px] md:rounded-[32px] p-4 md:p-8">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <a href="{{ $item['url'] }}" class="flex flex-col items-center justify-center p-4 md:p-6 rounded-2xl hover:bg-white transition-all duration-300 group gap-3 border border-transparent hover:border-gray-200 hover:shadow-sm">
                ...
                <span class="font-medium text-xs sm:text-sm md:text-base text-navy text-center whitespace-nowrap">{{ $item['label'] }}</span>
            </a>
            @endforeach
        </div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
                <div class="mb-12 flex flex-col md:flex-row md:items-end gap-6 text-left md:justify-between">
                    <div class="max-w-2xl">
                        <p class="text-teal font-semibold tracking-wider text-xs md:text-sm uppercase mb-3">Mengenal Desa</p>
                        <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 font-display">
                            {{ \App\Services\SettingsService::get('profil_title', 'Keindahan Alam dan Harmoni Masyarakat') }}
                        </h2>
                    </div>
                </div>
                <div class="space-y-6 text-gray-500 text-base sm:text-lg lg:text-xl mb-8">
                    <p>
...
<section id="potensi-desa" class="pt-16 pb-16 md:pt-24 md:pb-24 bg-cream">
    <div class="w-full mx-auto px-4 md:px-8 lg:px-12 xl:px-24 2xl:px-32">
        <div class="mb-12 flex flex-col md:flex-row md:items-end gap-6 text-left md:justify-between">
            <div class="max-w-2xl">
                <p class="text-teal font-semibold tracking-wider text-xs md:text-sm uppercase mb-3">Potensi Unggulan</p>
                <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 font-display">
            ...
            <div class="shrink-0">
                ...
                <a href="{{ $linkPotensi }}" class="inline-flex items-center justify-center rounded-full font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-teal focus:ring-offset-2 border-2 border-navy text-navy hover:bg-navy hover:text-white px-5 py-2.5 sm:px-6 sm:py-3 text-xs sm:text-sm lg:text-base">
        ...
        <div class="grid lg:grid-cols-2 gap-6 md:gap-8 items-stretch">
            ...
            <{{ $pot1['link'] ? 'a' : 'div' }} {!! $pot1['link'] ? 'href="'.$pot1['link'].'"' : '' !!} class="block relative rounded-[32px] overflow-hidden group ring-4 ring-white shadow-lg h-full" style="min-height: 450px;">
                ...
                <div class="absolute inset-0 p-8 flex flex-col justify-end">
                    ...
                    <h3 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 font-display">{{ $pot1['title'] }}</h3>
                    <p class="text-white/80 text-sm sm:text-base lg:text-lg max-w-md">{{ $pot1['desc'] }}</p>
                    @if($pot1['link'])
            ...
            <div class="flex flex-col gap-6 md:gap-8 h-full">
                ...
                <{{ $pot2['link'] ? 'a' : 'div' }} {!! $pot2['link'] ? 'href="'.$pot2['link'].'"' : '' !!} class="block relative rounded-[32px] overflow-hidden group ring-4 ring-white shadow-lg" style="flex: 1 1 0%; min-height: 250px;">
                    ...
                    <div class="absolute inset-0 p-6 flex flex-col justify-end">
                        <h3 class="text-xl sm:text-2xl font-bold text-white mb-2 font-display">{{ $pot2['title'] }}</h3>
                ...
                <{{ $pot3['link'] ? 'a' : 'div' }} {!! $pot3['link'] ? 'href="'.$pot3['link'].'"' : '' !!} class="block relative rounded-[32px] overflow-hidden group ring-4 ring-white shadow-lg" style="flex: 1 1 0%; min-height: 250px;">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-navy/90 to-transparent"></div>
                    <div class="absolute inset-0 p-6 flex flex-col justify-end">
                        <h3 class="text-xl sm:text-2xl font-bold text-white mb-2 font-display">{{ $pot3['title'] }}</h3>
    ...
    <div class="w-full mx-auto px-4 md:px-8 lg:px-12 xl:px-24 2xl:px-32">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 md:gap-12">
            <div class="flex flex-col items-center text-center md:items-start md:text-left border-l-0 md:border-l border-white/20 pl-0 md:pl-6">
                ...
                <div class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-1 md:mb-2 font-display">{{ \App\Services\SettingsService::get('stat_population', '3.450') }}</div>
                <div class="text-xs sm:text-sm md:text-base text-white/70 font-medium">Jumlah Penduduk</div>
            </div>
            <div class="flex flex-col items-center text-center md:items-start md:text-left border-l-0 md:border-l border-white/20 pl-0 md:pl-6">
                <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/10 flex items-center justify-center text-lime mb-3 md:mb-4">
                ...
                <div class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-1 md:mb-2 font-display">{{ \App\Services\SettingsService::get('stat_families', '850') }}</div>
                <div class="text-xs sm:text-sm md:text-base text-white/70 font-medium">Kepala Keluarga</div>
            </div>
            <div class="flex flex-col items-center text-center md:items-start md:text-left border-l-0 md:border-l border-white/20 pl-0 md:pl-6">
                <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/10 flex items-center justify-center text-lime mb-3 md:mb-4">
                    <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                </div>
                <div class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-1 md:mb-2 font-display">{{ \App\Services\SettingsService::get('stat_area', '1.250') }}</div>
                <div class="text-xs sm:text-sm md:text-base text-white/70 font-medium">Luas Wilayah (Ha)</div>
            </div>
            <div class="flex flex-col items-center text-center md:items-start md:text-left border-l-0 md:border-l border-white/20 pl-0 md:pl-6">
                <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/10 flex items-center justify-center text-lime mb-3 md:mb-4">
                    <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"></path></svg>
                </div>
                <div class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-1 md:mb-2 font-display">{{ \App\Services\SettingsService::get('stat_hamlets', '4') }}</div>
                <div class="text-xs sm:text-sm md:text-base text-white/70 font-medium">Jumlah Dusun</div>
            </div>
        </div>
    </div>
</section>
...
<section id="berita" class="py-16 md:py-24 bg-white">
    <div class="w-full mx-auto px-4 md:px-8 lg:px-12 xl:px-24 2xl:px-32">
        <div class="mb-12 flex flex-col md:flex-row md:items-end gap-6 text-left md:justify-between">
            <div class="max-w-2xl">
                <p class="text-teal font-semibold tracking-wider text-xs md:text-sm uppercase mb-3">Kabar Terbaru</p>
                <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 font-display">Berita & Pengumuman Desa</h2>
            </div>
            <div class="shrink-0">
        ...
        <div class="grid lg:grid-cols-12 gap-8">
            ...
            <a href="{{ route('news.show', $mainNews->slug) }}" class="lg:col-span-7 group cursor-pointer block">
                ...
                <h3 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-navy mb-4 group-hover:text-teal transition-colors font-display">
                    {{ $mainNews->title }}
                </h3>
                <p class="text-base sm:text-lg lg:text-xl text-gray-500 mb-6 line-clamp-2">{{ Str::limit(strip_tags($mainNews->content), 150) }}</p>
    ...
    <div class="w-full mx-auto px-4 md:px-8 lg:px-12 xl:px-24 2xl:px-32">
        <div class="mb-12 flex flex-col md:flex-row md:items-center gap-6 text-center md:justify-center">
            <div class="max-w-2xl mx-auto">
                <p class="text-teal font-semibold tracking-wider text-xs md:text-sm uppercase mb-3">Galeri Desa</p>
                <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 font-display">Rekaman Visual Kehidupan</h2>
                <p class="text-gray-500 text-base sm:text-lg lg:text-xl">Dokumentasi kegiatan, keindahan alam, dan momen kebersamaan masyarakat Desa Kertajaya.</p>
            </div>
        </div>
                ...
                @if($idx === 0)
                    ...
                    <a href="{{ route('gallery.show', $album->slug) }}" class="col-span-2 row-span-1 md:row-span-2 rounded-[24px] overflow-hidden group relative block bg-gray-200">
                        ...
                        <div class="absolute bottom-6 left-6 text-white">
                            ...
                            <p class="text-xs sm:text-sm text-white/80">{{ $album->published_at->format('d M Y') }}</p>
                        </div>
                    </a>
                @elseif($idx === 1)
                    <!-- Second album -->
                    <a href="{{ route('gallery.show', $album->slug) }}" class="col-span-2 row-span-1 rounded-[24px] overflow-hidden group relative block bg-gray-200">
                        ...
                        <div class="absolute bottom-4 left-4 text-white">
                            <h4 class="font-bold text-base sm:text-lg lg:text-xl font-display">{{ $album->title }}</h4>
                        </div>
                    </a>
                @elseif($idx === 2)
                    <!-- Third album -->
...
<section id="dokumen" class="py-16 md:py-24 bg-white">
    <div class="w-full mx-auto px-4 md:px-8 lg:px-12 xl:px-24 2xl:px-32">
        <div class="mb-12 flex flex-col md:flex-row md:items-end gap-6 text-left md:justify-between">
            <div class="max-w-2xl">
                <p class="text-teal font-semibold tracking-wider text-xs md:text-sm uppercase mb-3">Transparansi & Dokumen</p>
                <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 font-display">Dokumen Publik Desa</h2>
            </div>
            <div class="shrink-0">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between p-6 md:p-8 gap-6 hover:bg-cream/50 transition-colors {{ !$loop->last ? 'border-b border-gray-200' : '' }}">
                <div class="flex items-start gap-4 md:gap-6 flex-1">
                    ...
                    <div>
                        ...
                        <h4 class="font-bold text-base sm:text-lg md:text-xl lg:text-2xl text-navy leading-snug">{{ $doc->title }}</h4>
                    </div>
                </div>
...
<section class="relative overflow-hidden text-center py-24 md:py-32 bg-teal text-white">
    ...
    <div class="relative z-10 max-w-3xl mx-auto px-4">
        <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-6 font-display">
        ...
        <a href="{{ route('public.contact.show') }}" class="inline-flex items-center justify-center rounded-full font-medium transition-colors bg-yellow text-navy hover:bg-yellow/90 shadow-sm px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg lg:text-xl">
