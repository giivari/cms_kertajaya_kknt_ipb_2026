            ...
            <div>
                ...
                <ul class="space-y-3 text-sm md:text-base text-white/70">
                    <li class="flex items-start gap-3">
                        ...
                        <span>
                            {{ \App\Services\SettingsService::get('address_street', 'Kantor Kepala Desa Kertajaya') }}<br>
                            {{ \App\Services\SettingsService::get('address_village', 'Desa Kertajaya') }}, 
                            {{ \App\Services\SettingsService::get('address_subdistrict', 'Kec. Simpenan') }}<br>
                            {{ \App\Services\SettingsService::get('address_district', 'Kab. Sukabumi') }}, 
                            {{ \App\Services\SettingsService::get('address_province', 'Jawa Barat') }} 
                            {{ \App\Services\SettingsService::get('address_postal_code', '43361') }}
                        </span>
                    </li>
